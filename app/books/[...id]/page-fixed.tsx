    ...
    async function fetchBookData() {
      ...
      try {
        ...
        if (bookId.includes("OL") || bookId.includes("works/")) {
          ...
          const apiBookId = bookId.startsWith("/") ? bookId : `/${bookId}`;
          ...
          if (openLibraryBook) {
            ...
            const transformedBook: Book = {
              ...
              author: openLibraryBook.authors?.[0]?.author?.key
                ? await fetchAuthorName(openLibraryBook.authors[0].author.key)
                : "Unknown Author",
              ...
              publishedYear: 0, // Not available in works API
              genre: openLibraryBook.subjects?.slice(0, 3) || [],
              isbn: "",
              rating: 0,
            };
